...
import { handleModal } from "../../reducers/app/appActions";
    ...
    return (
      <div className="gastos-container">
        ...
        <div className="gastos-container__subheader">
          <Button
            title="Nuevo gasto"
            onClick={() => this.props.handleModal(true, "NuevoGasto")}
          />
          <div className="gastos-container__subheader__total">
            Total de gastos en el mes: $2000
          </div>
        </div>
        <div className="gastos-container__body">
          <Table
            dataSource={this.props.gastos}
            columns={columns}
            size="small"
            loading={this.props.loadingGastos}
          />
          ;
        </div>
      </div>
